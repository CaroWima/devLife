...
<!-- article -->
  <div class="article">
    <h2>Who loves Maths? And I mean LOVES math</h2>
    <p>
    <small>
        <i>
          <p>Maths is great, everybody loves math. When you're a child, you wanted to go to school asap bc of the fun math lessons and so did everyone else.</p>
          <p>All the more unfortunate is the state of people nowadays who do not have the slightest idea of what it's good for or where you can use it.</p>
          <p>But, i hear you say, maths is awesome and you can use it anywhere...right? Well...absolutely! Where and how EXACTLY though?</p>
    ...
    <h3>And that's exactly the spirit you need!</h3>
    <p>
