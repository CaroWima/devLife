...
function varExample1(target) {
    ...
    target.parentElement.nextElementSibling.nextElementSibling.innerHTML = outputText;
...
function dataobjectExample1(target) {    
    ...
    console.log(target.parentElement.nextElementSibling.nextElementSibling.innerHTML);
